          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex gap-3 items-center">
                ...
                <a href="mailto:sales@hoakengineers.com" className="text-white/60 text-sm font-body hover:text-brand-gold transition-colors">
              ...
              <li className="flex gap-3 items-center">
                ...
                <a href="https://www.hoakengineers.com" target="_blank" rel="noopener noreferrer" className="text-white/60 text-sm font-body hover:text-brand-gold transition-colors">
                  www.hoakengineers.com
                </a>
              </li>
            </ul>
          </div>
